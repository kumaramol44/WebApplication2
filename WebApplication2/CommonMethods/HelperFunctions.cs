...
namespace WebApplication2.CommonMethods
{
    ...
    public class HelperFunctions
    {
        ...
        public static bool IsBase64String(string imgStr)
        {
            var tempImg = imgStr.Split(',');
            if (tempImg == null || tempImg[0] != "data:image/png;base64")
            {
                return false;
            }
            var base64String = tempImg[1].ToString();
